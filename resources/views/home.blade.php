		...
		<div class="col-sm-3">
			<div class="card">
                ...
                <div class="card-body">
					...
					<div class="text-center"><a href="{{ route('furniture')}}" class="btn btn-primary">Selengkapnya</a></div>
		...
		<div class="col-sm-3">
			<div class="card">
                ...
                <div class="card-body">
					...
					<div class="text-center"><a href="{{ route ('kostum')}} " class="btn btn-primary">Selengkapnya</a></div>
				</div>
			</div>
		</div>
		...
		<div class="col-sm-3">
			<div class="card">
                ...
                <div class="card-body">
					...
					<div class="text-center"><a href="{{ route ('musik')}} " class="btn btn-primary">Selengkapnya</a></div>
				</div>
			</div>
		</div>
		...
		<div class="col-sm-3">
			<div class="card">
                ...
                <div class="card-body">
					...
					<div class="text-center"><a href="{{ route ('elektronik')}} " class="btn btn-primary">Selengkapnya</a></div>
				</div>
			</div>
		</div>
	...
	<div class="col-sm-3">
			<div class="card">
                ...
                <div class="card-body">
					...
					<div class="text-center"><a href="{{ route ('tenda')}}" class="btn btn-primary">Selengkapnya</a></div>
				</div>
			</div>
		</div>
