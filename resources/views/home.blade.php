			...
			<div class="col-sm-3">
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="text-center"><button type="button" href="{{ route('furniture')}}" class="btn btn-outline-success">Selengkapnya</button></div>
			...
			<div class="col-sm-3">
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="text-center"><button type="button" href="{{ route ('kostum')}} " class="btn btn-outline-success">Selengkapnya</button></div>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-3">
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="text-center"><button type="button" href="{{ route ('musik')}} " class="btn btn-outline-success">Selengkapnya</button></div>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-3">
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="text-center"><button type="button" href="{{ route ('elektronik')}} " class="btn btn-outline-success">Selengkapnya</button></div>
					</div>
				</div>
			</div>
		...
		<div class="col-sm-3">
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="text-center"><button type="button" href="{{ route ('tenda')}} " class="btn btn-outline-success">Selengkapnya</button></div>
					</div>
				</div>
			</div>
